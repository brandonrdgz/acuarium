...
class ListadoPedidosClientePantalla extends StatefulWidget {
  static const String id = 'ListadoPedidosCliente';
  const ListadoPedidosClientePantalla({ Key? key }) : super(key: key);

  @override
  _ListadoPedidosClientePantallaState createState() => _ListadoPedidosClientePantallaState();
}

class _ListadoPedidosClientePantallaState extends State<ListadoPedidosClientePantalla> {
...
@override
  ...
  stream: Firestore.listaPedidosCliente(uid: Auth.getUserId()!),
